...
if(isset($_POST['proses']) && $_POST['proses'] == "add"){
    ...
    $statement_sql = $cn_mysql->prepare("insert into product_category(category_name, isactive) values(?, 1)");
...
if(isset($_POST['proses']) && $_POST['proses'] == "delete"){
    $statement_sql = $cn_mysql->prepare("UPDATE product_category SET isactive=1 WHERE categoryid=".$_POST['keyid']."");
    if($statement_sql->execute()){
        back("../home.php?modul=kategori");
        notif("Hapus Data Berhasil");
    }
